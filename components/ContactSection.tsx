...
export const ContactSection: React.FC = () => {
  ...
  const handleWhatsappClick = (e: React.MouseEvent) => {
    if (!WHATSAPP_LINK) {
      e.preventDefault();
      alert(t('contact.configMissingWhatsapp'));
    }
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <div className="mt-6 p-6 bg-white rounded-xl shadow-md border border-green-100">
              <h3 className="text-xl font-bold text-gray-900 mb-2">{t('contact.whatsappTitle')}</h3>
              <p className="text-gray-600 mb-4">
              ...
              <a
                ...
                className="inline-flex items-center justify-center w-full px-6 py-3 bg-[#25D366] hover:bg-[#20BA5A] text-white font-semibold rounded-lg transition-colors"
              >
                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
