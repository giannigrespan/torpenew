...
// Define icons separately to keep them accessible
const FEATURE_ICONS = [
  (
...
export const Features: React.FC = () => {
  ...
  // Build features array dynamically using translation keys
  const FEATURES: Feature[] = FEATURE_KEYS.map((key, index) => ({
